namespace RentAWheel
{
    partial class FleetView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fleetViewGrid = new System.Windows.Forms.DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.fleetViewGrid)).BeginInit();
            ...
            // fromMaintenance
            // 
            this.fromMaintenance.Enabled = false;
            ...
            // toMaintenance
            // 
            this.toMaintenance.Enabled = false;
            ...
            // fleetViewGrid
            // 
            this.fleetViewGrid.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.LicencePlate,
            this.Category,
            this.Available,
            this.InOperation,
            ...
            this.docNumber,
            this.docType});
            this.fleetViewGrid.Location = new System.Drawing.Point(12, 37);
            this.fleetViewGrid.MultiSelect = false;
            this.fleetViewGrid.Name = "fleetViewGrid";
            this.fleetViewGrid.RowTemplate.Height = 24;
            this.fleetViewGrid.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
            this.fleetViewGrid.Size = new System.Drawing.Size(704, 423);
            this.fleetViewGrid.TabIndex = 19;
            this.fleetViewGrid.Text = "DataGridView1";
            this.fleetViewGrid.SelectionChanged += new System.EventHandler(this.gridFleetView_SelectionChanged);
            // 
            // LicencePlate
            // 
            ...
            this.Controls.Add(this.fleetViewGrid);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.fleetViewGrid)).EndInit();
        ...
        internal System.Windows.Forms.DataGridView fleetViewGrid;
